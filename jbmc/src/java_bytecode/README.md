...
assignments. See \ref java-trace-member-assignment "Member assignments".
...
(noting that \ref java-trace-array-assignment Strings are an exception,
...
- \ref symbol_exprt = \ref const_exprt with a value representing the primitive

An assignment of a non-primitive (struct) variable can have the following forms:
- \ref symbol_exprt = \ref struct_exprt
- \ref symbol_exprt = \ref const_exprt with an \ref address_of_exprt pointing to a symbol that has a \ref struct_exprt value
...
where the members of the \ref struct_exprt are zero-intialized (null for
...
- \ref member_exprt of the \ref symbol_exprt containing the member = \ref const_exprt with an \ref address_of_exprt pointing to a symbol that has a \ref struct_exprt value.
...
CProver start initializes the instance of the class containing the function under test, Example, to have `null` static field:
...
- \ref symbol_exprt `java::ReferenceTypePrimitiveField.<init>:(I)V::this` = \ref const_exprt with \ref address_of_exprt pointing to `symex_dynamic::dynamic_object2`
- \ref symbol_exprt `java::ReferenceTypePrimitiveField.<init>:(I)V::i` = \ref const_exprt with value `5`

Call to the super constructor (Object). The `to_construct` parameter is internal
- \ref symbol_exprt `java::java.lang.Object.<init>:()V::this` = \ref const_exprt with \ref address_of_exprt pointing to `symex_dynamic::dynamic_object2`
- \ref symbol_exprt `java::java.lang.Object.<init>:()V::to_construct` = \ref const_exprt with \ref address_of_exprt pointing to `symex_dynamic::dynamic_object2`
...
- \ref member_exprt `symex_dynamic::dynamic_object2.primitiveField` = \ref const_exprt with value `5`

Call to the constructor of ReferenceTypeReferenceField, initalizing the parameters `this` and `r`
- \ref symbol_exprt `java::ReferenceTypeReferenceField.<init>:(LReferenceTypePrimitiveField;)V::this` = \ref const_exprt with \ref address_of_exprt pointing to `symex_dynamic::dynamic_object1`
- \ref symbol_exprt `java::ReferenceTypeReferenceField.<init>:(LReferenceTypePrimitiveField;)V::r` = \ref const_exprt with \ref address_of_exprt pointing to `symex_dynamic::dynamic_object2`

Call to the super constructor (Object). The `to_construct` parameter is internal
- \ref symbol_exprt `java::java.lang.Object.<init>:()V::this` = \ref const_exprt with \ref address_of_exprt pointing to `symex_dynamic::dynamic_object1`
- \ref symbol_exprt `java::java.lang.Object.<init>:()V::to_construct` = \ref const_exprt with \ref address_of_exprt pointing to `symex_dynamic::dynamic_object1`
...
- \ref member_exprt `symex_dynamic::dynamic_object1.referenceField` = \ref const_exprt with \ref address_of_exprt pointing to `symex_dynamic::dynamic_object2`
...
- \ref symbol_exprt `java::ObjectReference.globalReferenceTypeReferenceField` = \ref const_exprt with \ref address_of_exprt pointing to `symex_dynamic::dynamic_object1`
